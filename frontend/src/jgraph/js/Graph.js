  ...
  this.graph.addMouseListener({
    mouseDown: mxUtils.bind(this, function (sender, me) {
      ...
      if (me.evt.which === 1) {
        ...
        /** Point relative to the page coordanate system. */
        const relativePoint = getRelativePoint(me.graphX, me.graphY);
        Window.jgraphChannel.emitMouseDown({ ...me, relativePoint });
      }
    ...
    mouseUp: mxUtils.bind(this, function (sender, me) {
      if (me.evt.which === 1) {
        ...
        const getRelativePoint = (x, y) => ({
          x: x - graphBounds.x,
          y: y - graphBounds.y,
          canvasWidth: graphBounds.width,
          canvasHeight: graphBounds.height,
        });
        /** Point relative to the page coordanate system. */
        const relativePoint = getRelativePoint(me.graphX, me.graphY);
        Window.jgraphChannel.emitMouseUp({ ...me, relativePoint });
      }
