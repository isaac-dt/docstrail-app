...
export declare class OpenDefinitionController {
    ...
    getOpenDefinition(req: Request, res: Response): Promise<any>;
    createOpenDefinition(req: Request, res: Response): Promise<any>;
    updateOpenDefinitionFields(req: Request, res: Response): Promise<any>;
