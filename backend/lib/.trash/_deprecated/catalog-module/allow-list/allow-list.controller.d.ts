...
export declare class AllowListController {
    ...
    getAllowList(req: Request, res: Response): Promise<any>;
    addOpenDefinition(req: Request, res: Response): Promise<any>;
    deleteOpenDef(req: Request, res: Response): Promise<any>;
