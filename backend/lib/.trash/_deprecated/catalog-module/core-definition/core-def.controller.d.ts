...
export declare class CoreDefinitionController {
    ...
    getCoreDefinition(req: Request, res: Response): Promise<any>;
    createCoreDefinition(req: Request, res: Response): Promise<any>;
    updateCoreDefinitionFields(req: Request, res: Response): Promise<any>;
