...
export declare const GetTemplateResponse: {
    ...
    fromPartial<I extends {
        ...
        targets?: (readonly {
            ...
            createdAt?: Date | undefined;
            updatedAt?: Date | undefined;
        } & { [K_8 in Exclude<keyof I["targets"][number], "id" | "name" | "clientId" | "createdAt" | "$type" | "updatedAt">]: never; })[] & { [K_9 in Exclude<keyof I["targets"], "$type" | keyof readonly {
            id?: string | undefined;
            name?: string | undefined;
            clientId?: string | undefined;
            createdAt?: Date | undefined;
        ...
        triggers?: (readonly {
            ...
            expectedDeliveryDate?: ({
                ...
                scheduledEvent?: ({
                    ...
                    day?: number | undefined;
                    month?: number | undefined;
                } & { [K_10 in Exclude<keyof I["triggers"][number]["expectedDeliveryDate"]["scheduledEvent"], "day" | "month" | "$type">]: never; }) | undefined;
                $case: "scheduledEvent";
            } & { [K_11 in Exclude<keyof I["triggers"][number]["expectedDeliveryDate"], "$type" | "$case" | "scheduledEvent">]: never; }) | ({
                specialEvent?: import("../trigger/trigger.pb").SpecialEvent | undefined;
            } & {
                $case: "specialEvent";
            } & {
                specialEvent?: import("../trigger/trigger.pb").SpecialEvent | undefined;
                $case: "specialEvent";
            } & { [K_12 in Exclude<keyof I["triggers"][number]["expectedDeliveryDate"], "$type" | "$case" | "specialEvent">]: never; }) | undefined;
        } & { [K_13 in Exclude<keyof I["triggers"][number], "id" | "name" | "description" | "createdAt" | "$type" | "updatedAt" | "rootId" | "expiresAt" | "expectedDeliveryDate">]: never; })[] & { [K_14 in Exclude<keyof I["triggers"], "$type" | keyof readonly {
            id?: string | undefined;
            name?: string | undefined;
            description?: string | undefined;
            createdAt?: Date | undefined;
    ...
    } & { [K_15 in Exclude<keyof I, "template" | "$type" | "bundle" | "packages" | "targets" | "triggers">]: never; }>(object: I): GetTemplateResponse;
};
