...
export declare class PackageController {
    ...
    getPackage(req: Request, res: Response): Promise<any>;
    createPackage(req: Request, res: Response): Promise<any>;
    updatePackageFields(req: Request, res: Response): Promise<any>;
    addOpenDef(req: Request, res: Response): Promise<any>;
