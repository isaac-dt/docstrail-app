...
export interface Value {
  ...
  kind?:
    ...
    | {
        $case: "structValue";
        structValue: {readonly [key: string]: any} | undefined;
      }
...
export const Struct: any = {
  ...
  fromJSON(object: any): Struct {
    return {
      ...
      fields: isObject(object.fields)
        ? Object.entries(object.fields).reduce<Map<string, any | undefined>>(
            (acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Struct>, I>>(object: I): Struct {
    ...
    message.fields = (() => {
      const m = new Map();
      ((object.fields as Map<string, any | undefined>) ?? new Map()).forEach(
        (value, key) => {
          if (value !== undefined) {
            m.set(key, value);
          }
...
export const Value = {
  ...
  fromPartial<I extends Exact<DeepPartial<Value>, I>>(object: I): Value {
    ...
    if (
      ...
      message.kind = {
        $case: "structValue",
        structValue: object.kind.structValue,
      };
    }
    if (
