...
export const ADDRESS_COLLECTION_NAME = "account-addresses";

/** Validation schema for the addresses collection. */
export const ADDRESS_COLLECTION_SCHEMA: CollectionSchema = {
  userId: {
    description: "user Id",
